            ...
            <form class="form-horizontal" enctype="multipart/form-data" method="post" action="registerOrNo.php">
                ...
                <div class="buttons">
                    <div class="pull-right">
                        <input class="btn hvr-hover"  type="submit" value="Register" name="enregistrer" class="btn btn-primary">
                    </div>
                </div>
...
// Hachage du mot de passe
  $pass_hache = password_hash($_POST['passwordClient'], PASSWORD_DEFAULT);

// Insertion
  $req = $bdd->prepare('INSERT INTO client (nameClient,lastnameClient,mailClient,passwordClient) VALUES(:nameClient,:lastnameClient,:mailClient,:passwordClient,CURDATE())');
  $req->execute(array(
     'nameClient' => $nameClient,
     'passwordClient' => $pass_hache,
